                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .navigationDestination(isPresented: $navigateToMessage) {
                            MessageGenerationViewControllerRepresentable(userTimezone: timezoneModel.userTimezone, teamTimezones: timezoneModel.teamTimezones, selectedDate: selectedDate)
                        }
                    }
                    .padding(.horizontal)
